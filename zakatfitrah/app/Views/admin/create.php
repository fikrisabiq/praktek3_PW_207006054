...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Forum Tambah Admin</h1>
    ...
    <div class="card-body">
        <form action="/admin/tambah" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" value="<?= old('username'); ?>" name="username">
