...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Forum Ubah Mustahik Warga</h1>
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="/warga/edit/<?= $data['id_mustahikwarga']; ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="row mb-3">
                <label for="judul" class="col-sm-2 col-form-label">Muzakki</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" value="<?= $data['nama']; ?>" name="nama" readonly>
